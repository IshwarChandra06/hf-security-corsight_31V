...
//		Date date = new Date();
//		DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
//		List<OrganizationDto> exceptionDataList = transactionRepository.countEmpPresentCustom(dateFormat.format(date));
//		
//		JSONObject returnObject = new JSONObject();
//        JSONObject jsonObject = new JSONObject();
//        JSONArray headerArray = new JSONArray();
...
//        		dateObject = (JSONObject)jsonObject.get(companyDto.getDateTime());
//        	}
//        	
//        	String currentHur = companyDto.getDateTime().split(":")[0];
//        	if((null == previousHur) || (previousHur.equalsIgnoreCase(currentHur))) {
//        		total += companyDto.getTotal();
//        		previousHur = currentHur;
//        		continue;
//        	}
//        	
//        	dateObject.put(companyDto.getCompany(), total);
//        	jsonObject.put(previousHur+":00:00", dateObject);
//        	total = companyDto.getTotal();
//        	previousHur = currentHur;
...
//        	dateObject.put(companyDtoObj.getCompany(), total);
//        	jsonObject.put(previousHur+":00:00", dateObject);

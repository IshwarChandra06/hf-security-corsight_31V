...
////        		String time = companyDto.getDateTime();
////        		
...
//        	dateObject.put(companyDto.getCompany(), companyDto.getTotal());
//        	
//        	jsonObject.put(companyDto.getDateTime(), dateObject);
//		}
//         
...
//		List<Transaction> transactionList = transactionRepository.getRealTimeDataCustom(paging);
//		
